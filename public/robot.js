    ...
    if (signal) {
      ...
      switch (signal.type) {
        ...
        case "trackTurnRight":
          ...
          DRDoubleSDK.sendCommand("navigate.drive", { throttle: 0, turn: 0.3, powerDrive: true});
          break;
        ...
        case "trackMoveFwd":
          DRDoubleSDK.sendCommand("navigate.enable");
          DRDoubleSDK.sendCommand("navigate.drive", { throttle: 0.5, turn: 0, powerDrive: false});
          break;
        ...
        case "stopNavigation":
          DRDoubleSDK.sendCommand("navigate.stop");
          break;

        case "navigateTarget":
          if (signal.hasOwnProperty("x") && signal.hasOwnProperty("y")) {
            DRDoubleSDK.sendCommand("navigate.target", { relative: false, x: signal.x, y: signal.y });
            DRDoubleSDK.sendCommand("pose.resetOrigin");
          }
          break;
      }
    }
